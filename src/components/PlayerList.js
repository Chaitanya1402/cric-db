    ...
    <>
      <div className='w-[85%] m-auto'>
        <div className="options font-medium">
          ...
          <button onClick={() => setActive('batsman')} className={`${active === 'bat' ? 'active' : ''} p-1 mx-2`}>Batsmen</button>
          <button onClick={() => setActive('wicket-keeper')} className={`${active === 'wk' ? 'active' : ''} p-1 mx-2`}>Wicket-keepers</button>
          <button onClick={() => setActive('all-rounder')} className={`${active === 'all-rounders' ? 'active' : ''} p-1 mx-2`}>All-rounders</button>
          <button onClick={() => setActive('bowler')} className={`${active === 'bowl' ? 'active' : ''} p-1 mx-2`}>Bowlers</button>
        </div>
