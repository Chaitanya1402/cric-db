      ...
      <div className="other-projects my-8">
        ...
        <div className="project-card my-8 bg-purple-200 p-4 rounded-md">
          ...
          <div className='my-2 flex items-center'>
            ...
            <a href='https://github.com/Chaitanya1402/online-events' className='px-2 text-blue-700 font-medium underline' target={"_blank"}>https://github.com/Chaitanya1402/online-events</a>
          </div>
        </div>
        ...
        <div className="project-card my-8 bg-purple-200 p-2 rounded-md">
          ...
          <div className='my-2 flex items-center'>
            <i class="fa-brands fa-github text-2xl"></i>
            <a href='https://github.com/Chaitanya1402' className='px-2 text-blue-700 font-medium underline' target={"_blank"}>Github Repo Link to be added here</a>
          </div>
          <div className='my-2 flex items-center'>
            <img width={25} src={website_icon} alt="Website"/>
            <a href="https://genesismotorsports.vercel.app/" className='px-2 text-blue-700 font-medium underline' target={"_blank"}>https://genesismotorsports.vercel.app/</a>
          </div>
        </div>
        ...
        <div className="project-card my-8 bg-purple-200 p-2 rounded-md">
          ...
          <div className='my-2 flex items-center'>
            <i class="fa-brands fa-github text-2xl"></i>
            <a href='https://github.com/Chaitanya1402/todo-app' className='px-2 text-blue-700 font-medium underline' target={"_blank"}>https://github.com/Chaitanya1402/todo-app</a>
          </div>
          <div className='my-2 flex items-center'>
            <img width={25} src={website_icon} alt="Website"/>
            <a href="https://chaitanya1402-task-app.vercel.app/" className='px-2 text-blue-700 font-medium underline' target={"_blank"}>https://chaitanya1402-task-app.vercel.app/</a>
          </div>
        </div>
      </div>
